...
public class WhenGettingToken
{
        ...
        GovUkOidcConfiguration config)
    {
        ...
        var service = new Application.OneLogin.Services.OidcService(client, Mock.Of<IAzureIdentityService>(), jwtService.Object, config, Mock.Of<ICustomClaims>(), Mock.Of<ILogger<IOidcService>>());
